    ...
    <div className="row align-items-center justify-content-center mb-4">
            <div className="col-12 col-lg-8 col-md-8 col-sm-12 ">
                <div className=" mx-5 d-flex justify-content-center">
                    <div className={`${styles.accheader}  px-3`}>N.G.O Details</div>
                </div>
                <div className={`${styles.accform} h-90 p-4 m-2`}>
                    <form className="row g-3">

                        <div className="col-6">
                            <label for="inputName" className="form-label fs-4 ">Name of V.O./N.G.O.</label>
                            <input type="text" className={`form-control ${styles.inputac}`} id="inputName" placeholder="N.G.O. Name"/>
                        </div>
                        <div className="col-6">
                        ...
                        <div className="col-12">
                            <div className="row">
                                <div className="col-6">
                                    <label for="inputOccupation" className="form-label fs-4">Sectors working in</label>
